...
updateLight3();
  ...
  //   //bedroom lamp light
  //   bedroomLamp = new THREE.PointLight(0xffff00, 0.1, 70);
  //   bedroomLamp.position.set(32, 35, -120);
  //   scene.add(bedroomLamp);

  //   // dining room light
  //   diningroomLight = new THREE.PointLight(0xffffff, 0.1, 50);
  //   diningroomLight.position.set(-27, 17, -70);
  //   scene.add(diningroomLight);

  //   // kitchen light
  //   kitchenLight = new THREE.PointLight(0xffff22, 0.1, 80);
  //   kitchenLight.position.set(-30, 17, -10);
  //   scene.add(kitchenLight);

  //   // bathroom light
  //   bathroomLight = new THREE.PointLight(0xffa500, 0.1, 25);
  //   bathroomLight.position.set(30, 18, -5);
  //   scene.add(bathroomLight);

  //   // living room light
  //   livingroomLight = new THREE.PointLight(0xaa00ff, 0.1, 28);
  ...
  loader.load(
    "model/house_fp_2.obj",
    "model/house_fp_2.mtl",
    function (object) {
  ...
  //   var bathroomMaterial = new THREE.MeshLambertMaterial({
  //     map: textureBath,
  //     side: THREE.DoubleSide,
  //     transparent: false,
  //   });
  ...
  //   // Set position and rotate to be flat against ground
  //   bathroomPlane.position.set(15.5, 0.4, -38);
  ...
  //   bathMirCubeCamera = new THREE.CubeCamera(0.1, 200, 512);
  //   scene.add(bathMirCubeCamera);
  //   // Map the mirrorcamera to the plane
  //   var bathMirCubeMat = new THREE.MeshBasicMaterial({
  //     envMap: bathMirCubeCamera.renderTarget,
  //   });
  ...
  //   var diningMaterial = new THREE.MeshLambertMaterial({
  //     map: textureDining,
  //     side: THREE.DoubleSide,
  //   });
  //   diningPlane = new THREE.Mesh(diningGeometry, diningMaterial);
  //   // Set position and rotate to be flat against ground
  //   diningPlane.position.set(-45, 0.4, -134);
  ...
  //   // Set position and rotate to be flat against ground
  //   bedPlane.position.set(16, 0.4, -133.5);
  ...
  //   bedMirCubeCamera = new THREE.CubeCamera(0.1, 400, 512);
  //   scene.add(bedMirCubeCamera);
  //   var bedMirCubeMat = new THREE.MeshBasicMaterial({
  //     envMap: bedMirCubeCamera.renderTarget,
  //   });
  ...
  //   var hall1Material = new THREE.MeshLambertMaterial({
  //     map: textureHall1,
  //     side: THREE.DoubleSide,
  //   });
  //   hall1Plane = new THREE.Mesh(hall1Geometry, hall1Material);
  //   // Set position and rotate to be flat against ground
  //   hall1Plane.position.set(15.5, 0.4, -67);
  ...
  //   var hall2Material = new THREE.MeshLambertMaterial({
  //     map: textureHall2,
  //     side: THREE.DoubleSide,
  //   });
  //   hall2Plane = new THREE.Mesh(hall2Geometry, hall2Material);
  //   // Set position and rotate to be flat against ground
  //   hall2Plane.position.set(15, 0.4, 5);
...
function makeGui1() {
  ...
  var view = folder1
    .add(guiConfig, "cameraView", ["Top-down", "First-person"])
    .name("Camera View")
    .onChange(function () {
      if (guiConfig.cameraView == "Top-down") {
        // camera angle for top-down view
        roofMaterial.opacity = 0;
        controls = new THREE.OrbitControls(camera, renderer.domElement);
        // topdown position
        camera.position.y = 240;
  ...
  folder2
    .add(guiConfig, "changeFloorLiving", [
      "Tile",
      "Light brown wood",
      "Stone",
      "Dark brown wood",
  ...
  folder2
    .add(guiConfig, "changeFloorKitchen", [
      "Tile",
      "Light brown wood",
      "Stone",
      "Dark brown wood",
  ...
  folder2
    .add(guiConfig, "changeFloorDining", [
      "Tile",
      "Light brown wood",
      "Stone",
      "Dark brown wood",
  ...
  folder2
    .add(guiConfig, "changeFloorHall1", [
      "Tile",
      "Light brown wood",
      "Stone",
      "Dark brown wood",
  ...
  folder2
    .add(guiConfig, "changeFloorHall2", [
      "Tile",
      "Light brown wood",
      "Stone",
      "Dark brown wood",
  ...
  var intens = folder1.add(light, "intensity").min(0).max(1).step(0.1).listen();
...
function makeGui2() {
  ...
  var intens = gui.add(light, "intensity").min(0).max(1).step(0.1).listen();
